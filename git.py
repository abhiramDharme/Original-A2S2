...
GRAY = (136, 136, 136)
RED = (255, 0, 0)
BLACK = (0, 0, 0)  # Color for the border

# Placeholder for locations and images
locations = [
    ("Images/1.jpg", (604, 497)),
    ("Images/2.jpg", (606, 512)),
    # ("Images/3.jpg", (612, 535)),
...
def calculate_score(guess_pos, actual_pos):
    ...
    score = max(0, 100 - distance/3)  # Example scoring logic
    return score
...
while running:
        ...
        if event.type == pygame.QUIT:
            ...
            if not play_button_clicked:
                if play_button.text_rect.collidepoint(mouse_pos):
                    ...
                    location_image = load_location_image(current_location[0], (int(SCREEN_WIDTH * 4 / 5), SCREEN_HEIGHT))
    ...
    if not play_button_clicked:
        ...
        screen.blit(pygame.transform.scale(location_image, (int(SCREEN_WIDTH * 1 / 5), SCREEN_HEIGHT)), (0, 0))
    else:
